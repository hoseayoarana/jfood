...
public class JFood
{
    ...
    public static void main(String[] args)
    {
        ...
        Customer customer1 = new Customer(1, "Jamal", "jamal..@gmail.com", "12345678",new GregorianCalendar(2020, 03, 13));
        Customer customer2 = new Customer(2, "Jamsan", "jamsan@gmail.com", "123456",new GregorianCalendar(2020, 02, 12));
        Customer customer3 = new Customer(3, "Jamakun", "jamkun@gmail.com", "654321",new GregorianCalendar(2020, 01, 11));
